...
A Language Server Protocol implementation for the **[Jai](https://github.com/jonblow)** programming language, **written in Jai**. Speaks LSP over stdio so any LSP-capable editor can drive it.
